    ...
    useEffect(() => {
        ...
        if (SpeechRecognition) {
            ...
            recognition.onresult = (event: any) => {
                ...
                // Wake word detection when not "officially" listening to a query
                if (!isListening && currentTranscript.toLowerCase().includes('noah')) {
            ...
            recognition.onend = () => {
                // Always keep it active for wake word if possible
