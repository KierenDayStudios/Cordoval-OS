...
5.  **Noah AI Assistant**: An advanced AI personality integrated into the taskbar.
    *   **App Awareness**: Noah can open any system or web app by voice command.
    *   **Memory (Brain)**: Noah remembers your name, job, and preferences to provide personalized help.
    *   **App Generation**: Noah can build and deploy custom micro-apps on the fly (e.g., "Build me a pomodoro timer").
    *   **Persistence**: Apps generated by Noah are saved to your Desktop and Documents folder for long-term use.
6.  **Terminal / Calculator**: Access to system utilities.
